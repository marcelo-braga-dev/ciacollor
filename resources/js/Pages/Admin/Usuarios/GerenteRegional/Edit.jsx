...
export default function ({dados}) {
    ...
    function submit(e) {
        e.preventDefault()
        router.put(route('admin.usuarios.gerente-regional.update', dados.id), {
            '_method' : 'put',
            ...data
        })
    }
    ...
    return (
        <Layout container titlePage="Editar Dados Vendedor" menu="usuarios" submenu="gerente_regional"
                voltar={route('admin.usuarios.gerente-regional.show', dados.id)}>
