...
export default function ({usuarios}) {
    ...
    function buscarDados(key, valor) {
        setData(key, valor)
        setLoading(true)
        axios.post(route('gerente.analise.desconto-medio-filtro', {...data, [key]: valor}))
            .then((response) => {
    ...
    useEffect(() => {
        axios.post(route('gerente.analise.desconto-medio-filtro', {...data}))
            .then((response) => {
    ...
    useEffect(() => {
        axios.post(route('gerente.analise.desconto-medio-clientes', {...data}))
            .then((response) => {
