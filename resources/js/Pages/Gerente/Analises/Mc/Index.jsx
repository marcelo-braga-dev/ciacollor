...
export default function ({usuarios}) {
    ...
    function buscarDados(key, valor) {
        setData(key, valor)
        setLoading(true)
        axios.post(route('gerente.analise.mc-filtro', {...data, [key]: valor}))
            .then((response) => {
    ...
    useEffect(() => {
        axios.post(route('gerente.analise.mc-filtro', {...data}))
            .then((response) => {
                setDadados(response.data.tabela, response.data.media, response.data.media_valor)
            })
    ...
    useEffect(() => {
        axios.post(route('gerente.analise.mc-clientes', {...data}))
            .then((response) => {
