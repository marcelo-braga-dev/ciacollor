...
export default function ({usuarios}) {
    ...
    function buscarDados(key, valor) {
        setData(key, valor)
        setLoading(true)
        axios.post(route('gerente.analise.prazo-medio-filtro', {...data, [key]: valor}))
            .then((response) => {
    ...
    useEffect(() => {
        axios.post(route('gerente.analise.prazo-medio-filtro', {...data}))
            .then((response) => {
                setDadados(response.data.tabela, response.data.media)
            })
    }, []);
    ...
    useEffect(() => {
        axios.post(route('gerente.analise.prazo-medio-clientes', {...data}))
            .then((response) => {
